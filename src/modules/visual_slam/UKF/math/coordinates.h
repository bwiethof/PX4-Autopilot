...
\sa
https://web.archive.org/web/20181220230431/https://earth-info.nga.mil/GandG/publications/NGA_STND_0036_1_0_0_WGS84/NGA.STND.0036_1.0.0_WGS84.pdf
...
template <typename T> struct Ellipsoid {
  ...
  */
  [[nodiscard]] auto get_ht(const T w, const T z, const T sin_lat,
                            const T cos_lat, const T Rn) const {
    // https://www.gnu.org/software/libc/manual/html_node/Mathematical-Constants.html
    // cos(45 deg) == 1/sqrt(2)
    if (cos_lat > static_cast<T>(M_SQRT1_2)) // Equatorial
      return w / cos_lat - Rn;
    else // Polar
...
ukf::core::Vector<3> ECEFToLLa(const ukf::core::Vector<3> &);
